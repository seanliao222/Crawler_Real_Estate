...
if __name__ == '__main__':
    ...
    #將整合資料寫入CSV，為確保資料用excel打開中文編碼可以正確，編碼改用'utf-8-sig'帶入ＢOM   
    dataframes.to_csv('df_all.csv', index = False, header = True, encoding='utf-8-sig')
    #列出欄位類別，以利確認欄位資料是否正確
    ...
    df_filter.to_csv('filter.csv', index = False, header = True, encoding='utf-8-sig')
